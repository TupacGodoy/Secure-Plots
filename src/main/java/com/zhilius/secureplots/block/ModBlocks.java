...
public class ModBlocks {
    ...
    // Tier 1 - Iron
    public static final Block IRON_PLOT_BLOCK = register("iron_plot_block",
            new PlotBlock(AbstractBlock.Settings.create()
    ...
    // Tier 5 - Quantum
    public static final Block QUANTUM_PLOT_BLOCK = register("quantum_plot_block",
            new PlotBlock(AbstractBlock.Settings.create()
